...
import { NotFoundError, ErrorCodes, ValidationError } from "../utils/errors.js";
  ...
  try {
    ...
    if (req.body.key !== undefined) {
      throw new ValidationError(
        ...
        ErrorCodes.PROJECT_KEY_IMMUTABLE
      );
    }
    if (req.body.owner !== undefined) {
      throw new ValidationError(
        "Project owner cannot be modified",
        ErrorCodes.PROJECT_OWNER_IMMUTABLE
      );
    }
